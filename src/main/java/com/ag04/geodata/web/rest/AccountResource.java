...
import com.ag04.geodata.service.InvalidPasswordException;
import com.ag04.geodata.service.MailService;
import com.ag04.geodata.service.UserService;
import com.ag04.geodata.service.UsernameAlreadyUsedException;
...
import com.ag04.geodata.web.rest.errors.EmailNotFoundException;
import com.ag04.geodata.web.rest.errors.InvalidPasswordWebException;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.ag04.geodata.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
