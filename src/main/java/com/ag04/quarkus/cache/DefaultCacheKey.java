...
/**
 * A default cache key is used by the annotations caching API when a no-args method annotated with {@link Cached} or
 * {@link CacheInvalidate} is invoked. This class can also be used with the programmatic caching API.
 * 
 * This file is taken from: https://github.com/quarkusio/quarkus/blob/main/extensions/cache/runtime/src/main/java/io/quarkus/cache/DefaultCacheKey.java
 * 
 */
